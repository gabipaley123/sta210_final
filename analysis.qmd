...
The data used is sourced from a combination of Bloomberg, Compustat Fundamentals Quarterly (via Wharton Research) and Yahoo Finance. I have chosen a selection of variables from this dataset, using returns over multiple time horizons as my response and using Q/Q growth in revenue, free cash flow, net income, current ratio, and quick ratio, and earnings quality as measured by operating cash flow divided by net income.
