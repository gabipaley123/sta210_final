...
I also note that the predictive power of all of the above models is inherently low (as expected given the difficult nature of predicting returns). I have purposefully exclused R2 values as they are close to 0 for all the models above. However, these results can be layered into more sophisticated predictive models, and allow investors to gain a general sense of the relative importance of different metrics.  
